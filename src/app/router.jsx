...
import ProjectsGame from "../pages/projects/ProjectsGame.jsx";
import ProjectsRecipes from "../pages/projects/ProjectsRecipes.jsx";
        ...
        children: [
            ...
            },
            {
                ...
                children: [
                    ...
                    { path: "game", element: <ProjectsGame />, handle: {crumb: () => "Game" } },
                    { path: "recipes", element: <ProjectsRecipes />, handle: {crumb: () => "Recipes" } },
                ],
            },
            {
                path: "axioms",
